        ...
        <div>
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl md:text-3xl font-bold">Creator Deals</h1>
                    {activeCount > 0 && (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                <div className="glass-card p-4 text-center">
                    <p className="text-2xl font-bold text-yellow-400">{deals.filter(d => d.status === "requested").length}</p>
                    <p className="text-xs text-muted-foreground mt-1">Pending</p>
                </div>
                <div className="glass-card p-4 text-center">
                    <p className="text-2xl font-bold text-primary">{deals.filter(d => ["accepted", "in_progress"].includes(d.status)).length}</p>
                    <p className="text-xs text-muted-foreground mt-1">In Progress</p>
                </div>
                <div className="glass-card p-4 text-center">
                    <p className="text-2xl font-bold text-primary">{deals.filter(d => ["completed", "paid"].includes(d.status)).length}</p>
                        ...
                        >
                                    ...
                                    <div className="flex gap-2 shrink-0 flex-wrap" onClick={(e) => e.stopPropagation()}>
                                        ...
                                        {deal.status === "submitted" && (
                                            <>
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-2 px-4 py-2 bg-orange-500/10 text-orange-400 hover:bg-orange-500/20 rounded-lg border border-orange-500/20 transition-all text-sm font-medium"
                                                >
                                        ...
                                        {deal.status === "completed" && (
                                            <button
                                                ...
                                                className="flex items-center gap-2 px-4 py-2 bg-green-500/10 text-green-400 hover:bg-green-500/20 rounded-lg border border-green-500/20 transition-all text-sm font-medium"
                                            >
                                        ...
                                        {deal.status === "accepted" && (
                                            <span className="flex items-center gap-2 px-4 py-2 bg-blue-500/10 text-blue-400 rounded-lg border border-blue-500/20 text-sm">
                                                <AlertCircle className="w-4 h-4" /> Creator Working
                                            </span>
                                        )}
                                        {deal.status === "in_progress" && (
                                            <span className="flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary rounded-lg border border-primary/20 text-sm">
                            ...
                            {isExpanded && (
                                <div className="border-t border-white/5 p-5 bg-black/20 space-y-4 animate-fade-up">
                                    ...
                                    {deal.deliverables && (
                                        <div>
                                            <p className="font-medium text-xs text-muted-foreground mb-2 uppercase tracking-wider">Requirements Sent</p>
                                    ...
                                    {creator?.bio && (
                                        <div className="pt-3 border-t border-white/5">
                                            <p className="font-medium text-xs text-muted-foreground mb-2 uppercase tracking-wider">Creator Bio</p>
                                    ...
                                    {/* Contact Creator */}
                                    <div className="pt-3 border-t border-white/5">
                                        <p className="font-medium text-xs text-muted-foreground mb-3 uppercase tracking-wider">Contact Creator</p>
